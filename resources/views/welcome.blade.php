    ...
    <div id="app">
                ...
                <ul>
                    <li class="menu-item">
                        <a class="link" href="#orderKyiv">
                            обслуговування генераторів у місті Київ
                        </a>

                    </li>
                    <li class="menu-item">
                        <a class="link" href="#orderCherkasy">
                            обслуговування генераторів у місті Черкаси
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <article class="article">
            ...
            <section id="orderCherkasy">
                <h1>Ремонт та обслуговування генераторів у місті Черкассы, черкасская область.</h1>
            ...
            <section class="contact-us">
                ...
                <p class="text">Залиште заявку, і ми зв'яжемося з вами для консультації щодо ремонту та обслуговування генераторів.</p>
